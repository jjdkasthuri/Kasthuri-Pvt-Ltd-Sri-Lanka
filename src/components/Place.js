      ...
      <section className="place section" id="place">
        <div className="place__container container">
          <h2 className="section__title">
            ...
            at Kasthuri Steels and Fabrication Pvt Ltd
          </h2>
          ...
          <div className="place__content grid">
            <div className="place__images">
              <img
                src={selectedImage}
                alt="Kasthuri Steels Construction and Steel Fabrication 1"
            ...
            <div className="place__data">
              <h2 className="place__title">Discover Kasthuri Steels and Fabrication Pvt Ltd</h2>
              <p className="place__description">
              Kasthuri Steels and Fabrication Pvt Ltd excels in the construction industry, providing top-notch steel fabrication services.
